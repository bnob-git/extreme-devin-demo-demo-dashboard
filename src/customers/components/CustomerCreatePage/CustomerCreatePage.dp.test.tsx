...
jest.mock("@dashboard/components/AddressEdit/createCountryHandler", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  createCountryHandler: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
jest.mock("@dashboard/graphql", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  AccountErrorFragment: () => null,
  AddressInput: () => null,
  CustomerCreateDataQuery: () => null,
}));
...
describe("CustomerCreatePage deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders CustomerCreatePage with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <CustomerCreatePage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CustomerCreatePage with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <CustomerCreatePage {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
