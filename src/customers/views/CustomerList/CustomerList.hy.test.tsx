...
describe("CustomerList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders CustomerList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <CustomerList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CustomerList with override props", () => {
