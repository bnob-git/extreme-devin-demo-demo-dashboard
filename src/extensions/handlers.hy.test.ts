...
describe("handlers hybrid tests", () => {
  ...
  it("calls createSyncEventsSelectHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createSyncEventsSelectHandler with rich data args", () => {
    try {
  ...
  it("calls createSyncEventsSelectHandler with empty array", () => {
    try {
      const result = (createSyncEventsSelectHandler as any)([]);
  ...
  it("calls createAsyncEventsSelectHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createAsyncEventsSelectHandler with rich data args", () => {
    try {
  ...
  it("calls createAsyncEventsSelectHandler with empty array", () => {
    try {
      const result = (createAsyncEventsSelectHandler as any)([]);
