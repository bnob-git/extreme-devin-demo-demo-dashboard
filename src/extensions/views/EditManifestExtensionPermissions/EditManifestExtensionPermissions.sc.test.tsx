...
test("EditManifestExtensionPermissions can be imported", () => {
  expect(EditManifestExtensionPermissions).toBeDefined();
});

test("EditManifestExtensionPermissions renders without crashing", () => {
  try {
    const props = {} as any;

    render(React.createElement(EditManifestExtensionPermissions, props));
  } catch (_e) {
...
test("EditManifestExtensionPermissions renders with null values", () => {
  try {
    render(React.createElement(EditManifestExtensionPermissions, {} as any));
  } catch (_e) {
    // Expected
  }
