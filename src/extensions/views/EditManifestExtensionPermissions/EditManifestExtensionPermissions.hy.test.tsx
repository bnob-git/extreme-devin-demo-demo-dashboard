...
describe("EditManifestExtensionPermissions hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders EditManifestExtensionPermissions with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders EditManifestExtensionPermissions with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <EditManifestExtensionPermissions {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
