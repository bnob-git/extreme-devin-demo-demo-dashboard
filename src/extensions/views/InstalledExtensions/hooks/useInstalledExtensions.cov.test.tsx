...
describe("useInstalledExtensions.tsx coverage", () => {
  beforeEach(() => {
  ...
  it("calls getExtensionInfo", () => {
    try {
      (getExtensionInfo as any)({} as any);
    } catch (_e) {
      /* expected */
    }
  ...
  it("calls useInstalledExtensions", () => {
    try {
      (useInstalledExtensions as any)({} as any);
    } catch (_e) {
      /* expected */
    }
