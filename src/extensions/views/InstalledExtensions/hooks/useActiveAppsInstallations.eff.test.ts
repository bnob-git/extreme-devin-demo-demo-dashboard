// Auto-generated coverage test for useActiveAppsInstallations.ts
...
describe("useActiveAppsInstallations", () => {
  it("exports useActiveAppsInstallations", () => {
    expect(typeof useActiveAppsInstallations).toBe("function");
  });
});
