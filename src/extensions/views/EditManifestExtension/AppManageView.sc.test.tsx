...
test("EditManifestExtension can be imported", () => {
  expect(EditManifestExtension).toBeDefined();
});

test("EditManifestExtension renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(EditManifestExtension, props));
  } catch (_e) {
...
test("EditManifestExtension renders with null values", () => {
  try {
    render(React.createElement(EditManifestExtension, {} as any));
  } catch (_e) {
    // Expected
  }
