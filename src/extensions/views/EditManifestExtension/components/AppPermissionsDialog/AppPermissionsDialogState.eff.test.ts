// Auto-generated coverage test for AppPermissionsDialogState.ts
...
describe("AppPermissionsDialogState", () => {
  it("exports useAppPermissionsDialogState", () => {
    expect(typeof useAppPermissionsDialogState).toBe("function");
  });
});
