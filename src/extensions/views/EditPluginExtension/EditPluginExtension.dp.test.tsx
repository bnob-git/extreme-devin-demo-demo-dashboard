...
describe("EditPluginExtension deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders EditPluginExtension with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <EditPluginExtension {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders EditPluginExtension with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <EditPluginExtension {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
