...
describe("handlers body-aware tests", () => {
  ...
  it("calls createSyncEventsSelectHandler (L34-56) with body-aware args", () => {
    try {
      const result = (createSyncEventsSelectHandler as any)({
        change: {},
        data: { asyncEvents: [], syncEvents: [] },
        query: {},
  ...
  it("calls createAsyncEventsSelectHandler (L68-91) with body-aware args", () => {
    try {
