...
describe("SidebarContext.tsx coverage", () => {
  beforeEach(() => {
  ...
  it("calls useSidebarBreakpointContext", () => {
    try {
      (useSidebarBreakpointContext as any)({} as any);
    } catch (_e) {
      /* expected */
    }
  ...
  it("calls useCustomSidebarBreakpoint", () => {
    try {
      (useCustomSidebarBreakpoint as any)({} as any);
    } catch (_e) {
      /* expected */
    }
