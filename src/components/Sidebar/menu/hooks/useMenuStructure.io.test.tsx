...
describe("useMenuStructure", () => {
  test("useMenuStructure is exported", () => {
    expect(useMenuStructure).toBeDefined();
  });

  test("useMenuStructure can be called", () => {
    if (typeof useMenuStructure === "function") {
      try {
        (useMenuStructure as any)();
      } catch (_e) {
        /* ok */
      }
    }
