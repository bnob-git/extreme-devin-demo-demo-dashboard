...
describe("AssignContainerDialogSingle deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders AssignContainerDialogSingle with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <AssignContainerDialogSingle {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AssignContainerDialogSingle with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <AssignContainerDialogSingle {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
