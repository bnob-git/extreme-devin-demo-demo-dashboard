...
describe("AttributesFilterAPIProvider.tsx uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useAttributesFilterAPIProvider (uncovered fn L69)", () => {
    try {
      const result = (useAttributesFilterAPIProvider as any)(0, {}, {});
