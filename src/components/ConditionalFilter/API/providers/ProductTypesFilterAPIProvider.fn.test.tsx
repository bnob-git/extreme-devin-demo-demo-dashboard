...
describe("ProductTypesFilterAPIProvider.tsx uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useProductTypesFilterAPIProvider (uncovered fn L15)", () => {
    try {
      const result = (useProductTypesFilterAPIProvider as any)({ rowType: {} });
