...
describe("StaffMembersFilterAPIProvider.tsx uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useStaffMembersFilterAPIProvider (uncovered fn L21)", () => {
    try {
      const result = (useStaffMembersFilterAPIProvider as any)({ rowType: {} });
