...
describe("OrderFilterAPIProvider.tsx uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useOrderFilterAPIProvider (uncovered fn L156)", () => {
    try {
      const result = (useOrderFilterAPIProvider as any)(0, {}, {});
