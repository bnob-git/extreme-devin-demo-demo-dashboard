...
describe("intl deep coverage", () => {
  it("calls getLocalizedLabel with analyzed args", () => {
    try {
      const result = (getLocalizedLabel as any)({}, "test", {
  ...
  it("calls getLocalizedLabel with alt args", () => {
    try {
