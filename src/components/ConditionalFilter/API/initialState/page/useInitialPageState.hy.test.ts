...
describe("useInitialPageState hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useInitialPageState with createDeepMock args", () => {
    try {
  ...
  it("calls useInitialPageState with rich data args", () => {
    try {
  ...
  it("calls useInitialPageState with empty array", () => {
    try {
      const result = (useInitialPageState as any)([]);
