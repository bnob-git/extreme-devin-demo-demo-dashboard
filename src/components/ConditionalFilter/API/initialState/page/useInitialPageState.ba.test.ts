...
describe("useInitialPageState body-aware tests", () => {
  beforeEach(() => {
  ...
  it("calls useInitialPageState (L26-44) with body-aware args", () => {
    try {
      const result = (useInitialPageState as any)({ pageTypes: { length: 1 } });
