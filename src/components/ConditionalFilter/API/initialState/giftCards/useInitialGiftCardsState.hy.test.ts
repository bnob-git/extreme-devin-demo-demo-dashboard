...
describe("useInitialGiftCardsState hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useInitialGiftCardsState with createDeepMock args", () => {
    try {
  ...
  it("calls useInitialGiftCardsState with rich data args", () => {
    try {
  ...
  it("calls useInitialGiftCardsState with empty array", () => {
    try {
      const result = (useInitialGiftCardsState as any)([]);
