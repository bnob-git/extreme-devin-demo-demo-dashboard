...
describe("useInitialGiftCardsState.ts uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useInitialGiftCardsState (uncovered fn L34)", () => {
    try {
      const result = (useInitialGiftCardsState as any)({ length: 0 }, { length: 0 }, {});
