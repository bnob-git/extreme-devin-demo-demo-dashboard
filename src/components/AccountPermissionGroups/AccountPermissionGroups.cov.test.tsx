...
describe("components/AccountPermissionGroups/AccountPermissionGroups.tsx", () => {
  it("should render default export without crashing", () => {
    try {
      render(<AccountPermissionGroups {...({} as any)} />);
    } catch (e) {
  ...
  it("should have default export", () => {
    expect(AccountPermissionGroups).toBeDefined();
  });
});
