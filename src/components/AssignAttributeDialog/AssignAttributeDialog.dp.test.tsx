...
jest.mock("@dashboard/graphql", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  AvailableAttributeFragment: () => null,
}));
...
describe("AssignAttributeDialog deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders AssignAttributeDialog with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <AssignAttributeDialog {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AssignAttributeDialog with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <AssignAttributeDialog {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
