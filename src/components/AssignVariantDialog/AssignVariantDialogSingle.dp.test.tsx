...
describe("AssignVariantDialogSingle deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders AssignVariantDialogSingle with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <AssignVariantDialogSingle {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AssignVariantDialogSingle with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <AssignVariantDialogSingle {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
