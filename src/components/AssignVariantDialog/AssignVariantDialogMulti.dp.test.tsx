...
describe("AssignVariantDialogMulti deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders AssignVariantDialogMulti with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <AssignVariantDialogMulti {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AssignVariantDialogMulti with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <AssignVariantDialogMulti {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
