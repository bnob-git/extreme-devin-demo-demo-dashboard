...
describe("AssignProductDialogMulti deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders AssignProductDialogMulti with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <AssignProductDialogMulti {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AssignProductDialogMulti with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <AssignProductDialogMulti {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
