...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls permissionGroupsListStaticColumnsAdapter with mocked args", () => {
    try {
      const result = (permissionGroupsListStaticColumnsAdapter as any)(
        {
  ...
  it("calls permissionGroupsListStaticColumnsAdapter with null args", () => {
    try {
      const result = (permissionGroupsListStaticColumnsAdapter as any)(
        null as any,
        null as any,
