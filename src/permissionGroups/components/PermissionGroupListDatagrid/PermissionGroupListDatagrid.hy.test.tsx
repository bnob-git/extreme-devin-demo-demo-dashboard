...
describe("PermissionGroupListDatagrid hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders PermissionGroupListDatagrid with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders PermissionGroupListDatagrid with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <PermissionGroupListDatagrid {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
