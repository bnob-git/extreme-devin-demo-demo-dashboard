...
describe("datagrid", () => {
  test("permissionGroupsListStaticColumnsAdapter is exported", () => {
    expect(permissionGroupsListStaticColumnsAdapter).toBeDefined();
  });
  ...
  test("permissionGroupsListStaticColumnsAdapter can be called", () => {
    if (typeof permissionGroupsListStaticColumnsAdapter === "function") {
      try {
