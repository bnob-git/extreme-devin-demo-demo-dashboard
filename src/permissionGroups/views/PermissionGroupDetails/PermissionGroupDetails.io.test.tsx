...
describe("PermissionGroupDetails", () => {
  test("PermissionGroupDetails is exported", () => {
    expect(PermissionGroupDetails).toBeDefined();
  });

  test("PermissionGroupDetails can be called", () => {
    if (typeof PermissionGroupDetails === "function") {
      try {
