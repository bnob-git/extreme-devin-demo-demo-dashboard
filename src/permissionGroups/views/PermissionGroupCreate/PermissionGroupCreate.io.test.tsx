...
describe("PermissionGroupCreate", () => {
  test("PermissionGroupCreate is exported", () => {
    expect(PermissionGroupCreate).toBeDefined();
  });

  test("PermissionGroupCreate can be called", () => {
    if (typeof PermissionGroupCreate === "function") {
      try {
        (PermissionGroupCreate as any)();
      } catch (_e) {
        /* ok */
      }
    }
