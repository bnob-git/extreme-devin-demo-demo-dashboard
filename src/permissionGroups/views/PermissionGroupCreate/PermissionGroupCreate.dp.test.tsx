...
jest.mock("@dashboard/permissionGroups/components/PermissionGroupDetailsPage", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  PermissionData: () => null,
}));
...
describe("PermissionGroupCreate deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders PermissionGroupCreate with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <PermissionGroupCreate {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PermissionGroupCreate with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <PermissionGroupCreate {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
