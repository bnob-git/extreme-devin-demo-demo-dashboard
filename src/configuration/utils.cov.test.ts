...
describe("utils coverage", () => {
  it("calls getConfigMenuItemsPermissions", () => {
    try {
      const result = (getConfigMenuItemsPermissions as any)();
  ...
  it("calls hasUserMenuItemPermissions", () => {
    try {
      const result = (hasUserMenuItemPermissions as any)();
