...
describe("MenuDetailsPage.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders MenuDetailsPage with deep props", () => {
    try {
      render(
        <MemoryRouter>
          <MenuDetailsPage
  ...
  it("renders with realistic props", () => {
    const props = {
      ...
      errors: [] as any,
      id: "test-id",
      menu: { id: "test-id", name: "Test", __typename: "Menu" } as any,
      onDelete: jest.fn(),
      onItemAdd: jest.fn(),
      onItemClick: jest.fn(),
      onItemEdit: jest.fn(),
