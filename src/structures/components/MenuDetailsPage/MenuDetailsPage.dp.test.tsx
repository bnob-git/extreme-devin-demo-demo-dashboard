...
jest.mock("@dashboard/extensions/getExtensionsItems", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getExtensionsItemsForMenuDetails: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("MenuDetailsPage deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders MenuDetailsPage with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <MenuDetailsPage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders MenuDetailsPage with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <MenuDetailsPage {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
