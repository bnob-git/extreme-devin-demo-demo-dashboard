...
describe("TaxClassesList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders TaxClassesList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <TaxClassesList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders TaxClassesList with override props", () => {
