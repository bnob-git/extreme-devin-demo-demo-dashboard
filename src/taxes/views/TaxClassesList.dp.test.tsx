...
jest.mock("@dashboard/utils/handlers/metadataCreateHandler", () => ({
  ...
  createMetadataCreateHandler: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("TaxClassesList deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders TaxClassesList with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders TaxClassesList with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <TaxClassesList {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
