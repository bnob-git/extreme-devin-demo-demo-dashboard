...
test("TaxCountriesList can be imported", () => {
  expect(TaxCountriesList).toBeDefined();
});

test("TaxCountriesList renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(TaxCountriesList, props));
  } catch (_e) {
...
test("TaxCountriesList renders with null values", () => {
  try {
    render(React.createElement(TaxCountriesList, {} as any));
  } catch (_e) {
    // Expected
  }
