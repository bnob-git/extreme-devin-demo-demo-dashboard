jest.mock("@dashboard/graphql", () => ({
  ...
  TaxClassCreateErrorFragment: () => null,
...
jest.mock("@dashboard/utils/handlers/metadataCreateHandler", () => ({
  ...
  CreateMetadataHandlerFunctionResult: () => null,
}));
...
describe("TaxClassesList deep-mock tests", () => {
  beforeEach(() => {
  ...
  it("renders TaxClassesList with deep-mocked deps", () => {
    try {
      render(
        <MemoryRouter>
