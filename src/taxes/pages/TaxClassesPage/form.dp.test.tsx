...
jest.mock("@dashboard/taxes/utils/data", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getTaxClassInitialFormData: jest.fn((..._a: any[]) => createDeepMock()),
}));
jest.mock("@dashboard/taxes/utils/validation", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  validateTaxClassFormData: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("form deep-proxy tests", () => {
  ...
  it("renders TaxClassesForm with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <TaxClassesForm {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders TaxClassesForm with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <TaxClassesForm {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
