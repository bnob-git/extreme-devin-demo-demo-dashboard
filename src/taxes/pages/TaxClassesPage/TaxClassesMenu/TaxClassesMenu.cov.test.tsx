...
describe("TaxClassesMenu.tsx coverage", () => {
  it("should render TaxClassesMenu", () => {
    try {
      render(
        <MemoryRouter>
          <TaxClassesMenu {...({ selected: [], name: "test" } as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("should render TaxClassesMenu with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TaxClassesMenu
