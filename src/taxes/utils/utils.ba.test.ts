...
describe("utils body-aware tests", () => {
  ...
  it("calls mapUndefinedTaxRatesToCountries (L18-54) with body-aware args", () => {
    try {
      const result = (mapUndefinedTaxRatesToCountries as any)({
        taxClassCountryRates: { length: 1 },
      });
  ...
  it("calls mapUndefinedCountriesToTaxClasses (L61-74) with body-aware args", () => {
    try {
