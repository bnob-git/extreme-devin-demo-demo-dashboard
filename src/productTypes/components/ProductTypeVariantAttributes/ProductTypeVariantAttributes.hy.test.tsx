...
describe("ProductTypeVariantAttributes hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductTypeVariantAttributes with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders ProductTypeVariantAttributes with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ProductTypeVariantAttributes {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
