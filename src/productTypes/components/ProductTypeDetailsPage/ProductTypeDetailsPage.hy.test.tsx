...
describe("ProductTypeDetailsPage hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductTypeDetailsPage with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductTypeDetailsPage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductTypeDetailsPage with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ProductTypeDetailsPage {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
