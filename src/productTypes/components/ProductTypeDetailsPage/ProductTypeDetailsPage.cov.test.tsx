...
describe("ProductTypeDetailsPage.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders ProductTypeDetailsPage with deep props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders with realistic props", () => {
    const props = {
      ...
      onDelete: jest.fn(),
      onFetchMoreTaxClasses: jest.fn(),
      onHasVariantsToggle: jest.fn(),
      onSubmit: jest.fn(),
      saveButtonBarState: "default" as any,
      selectedVariantAttributes: [] as any,
