...
describe("index hybrid render tests", () => {
  ...
  it("renders ProductTypeUpdate with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductTypeUpdate {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductTypeUpdate with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ProductTypeUpdate {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
