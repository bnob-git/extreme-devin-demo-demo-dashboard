...
describe("ProductTypeList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductTypeList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductTypeList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductTypeList with override props", () => {
