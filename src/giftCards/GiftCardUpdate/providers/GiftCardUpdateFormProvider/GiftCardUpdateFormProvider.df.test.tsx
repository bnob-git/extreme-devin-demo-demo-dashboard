...
test("GiftCardUpdateFormProvider ((anonymous_9) L70) executes", () => {
  try {
    const result = (GiftCardUpdateFormProvider as any)({} as any);
...
test("GiftCardUpdateFormContext ((anonymous_13) L100) executes", () => {
  try {
    const result = (GiftCardUpdateFormContext as any)({} as any);
