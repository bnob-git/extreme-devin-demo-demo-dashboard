...
jest.mock("@dashboard/hooks/makeMutation", () => ({
  ...
  makeMutation: (..._a: any[]) => createDeepMock(),
}));
...
describe("GiftCardUpdateFormProvider hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders GiftCardUpdateFormProvider with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <GiftCardUpdateFormProvider {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders GiftCardUpdateFormProvider with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <GiftCardUpdateFormProvider {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
