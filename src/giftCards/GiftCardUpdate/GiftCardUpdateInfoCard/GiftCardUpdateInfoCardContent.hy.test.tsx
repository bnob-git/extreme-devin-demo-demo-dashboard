...
describe("GiftCardUpdateInfoCardContent hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders GiftCardUpdateInfoCardContent with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders GiftCardUpdateInfoCardContent with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <GiftCardUpdateInfoCardContent {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
