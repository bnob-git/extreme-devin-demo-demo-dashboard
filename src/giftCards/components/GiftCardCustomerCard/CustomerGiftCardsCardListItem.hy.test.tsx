...
describe("CustomerGiftCardsCardListItem hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders CustomerGiftCardsCardListItem with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders CustomerGiftCardsCardListItem with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <CustomerGiftCardsCardListItem {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
