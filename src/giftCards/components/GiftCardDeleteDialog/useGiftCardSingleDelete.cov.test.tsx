...
describe("useGiftCardSingleDelete.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders useGiftCardSingleDelete with deep props", () => {
    try {
      render(
        <MemoryRouter>
          <useGiftCardSingleDelete
            {...({
              id: "test-id",
              loading: false,
              disabled: false,
  ...
  it("renders with realistic props", () => {
    const props = {
      deleteGiftCardOpts: [] as any,
      onDeleteGiftCard: jest.fn(),
    };

    try {
      render(
        <MemoryRouter>
          <useGiftCardSingleDelete {...props} />
        </MemoryRouter>,
      );
    } catch (_e) {
