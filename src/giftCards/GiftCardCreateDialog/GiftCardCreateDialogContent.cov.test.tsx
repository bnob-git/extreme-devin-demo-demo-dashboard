...
describe("GiftCardCreateDialogContent.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders GiftCardCreateDialogContent with deep props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders with realistic props", () => {
    const props = {
      onClose: jest.fn(),
      refetchQueries: [] as any,
    };

    try {
      render(
        <MemoryRouter>
          <GiftCardCreateDialogContent {...props} />
        </MemoryRouter>,
      );
    } catch (_e) {
