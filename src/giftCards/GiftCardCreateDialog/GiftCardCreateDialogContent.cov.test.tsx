...
describe("GiftCardCreateDialogContent.tsx coverage", () => {
  it("should render GiftCardCreateDialogContent", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render GiftCardCreateDialogContent with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <GiftCardCreateDialogContent
