...
describe("GiftCardListProvider hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders GiftCardsListProvider with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <GiftCardsListProvider {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders GiftCardsListProvider with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <GiftCardsListProvider {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
