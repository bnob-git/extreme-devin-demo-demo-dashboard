...
describe("GiftCardListProvider.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders GiftCardsListProvider", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("calls useGiftCardList", () => {
    try {
      (useGiftCardList as any)({} as any);
    } catch (_e) {
      /* expected */
    }
