...
test("GiftCardsListDatagrid ((anonymous_9) L116) executes", () => {
  try {
    const result = (GiftCardsListDatagrid as any)({} as any);
...
test("GiftCardsListDatagrid ((anonymous_5) L75) executes", () => {
  try {
    const result = (GiftCardsListDatagrid as any)({} as any);
