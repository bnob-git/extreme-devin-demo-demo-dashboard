...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls getColumns with mocked args", () => {
    try {
  ...
  it("calls getColumns with null args", () => {
    try {
      const result = (getColumns as any)(null as any, null as any);
  ...
  it("calls result of getColumns", () => {
    try {
      const handler = (getColumns as any)(
        {
          formatMessage: (m: any) => m?.defaultMessage || "",
          formatDate: (d: any) => d,
          formatTime: (t: any) => t,
