...
describe("WarehouseList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders WarehouseList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <WarehouseList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders WarehouseList with override props", () => {
