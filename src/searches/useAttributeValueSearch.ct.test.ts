...
describe("useAttributeValueSearch comprehensive tests", () => {
  beforeEach(() => {
  ...
  it("calls useSearchAttributeValuesSuggestions without args", () => {
    try {
  ...
  it("calls searchAttributeValues without args", () => {
    try {
