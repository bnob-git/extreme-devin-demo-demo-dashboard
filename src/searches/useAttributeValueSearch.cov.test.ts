...
describe("useAttributeValueSearch deep coverage", () => {
  it("accesses makeSearch", () => {
    try {
      if (typeof makeSearch === "function") {
        (makeSearch as any)({});
      } else {
  ...
  it("accesses searchAttributeValues", () => {
    try {
      if (typeof searchAttributeValues === "function") {
  ...
  it("calls useSearchAttributeValuesSuggestions with analyzed args", () => {
    try {
