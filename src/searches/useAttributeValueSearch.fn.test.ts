...
describe("useAttributeValueSearch.ts uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useSearchAttributeValuesSuggestions (uncovered fn L33)", () => {
    try {
      const result = (useSearchAttributeValuesSuggestions as any)({ attribute: {} });
