...
describe("useAttributeValueSearch body-aware tests", () => {
  beforeEach(() => {
  ...
  it("calls useSearchAttributeValuesSuggestions (L33-46) with body-aware args", () => {
    try {
      const result = (useSearchAttributeValuesSuggestions as any)("test-id", {});
