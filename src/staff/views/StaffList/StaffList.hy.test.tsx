...
describe("StaffList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders StaffList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <StaffList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders StaffList with override props", () => {
