...
describe("useProfileOperations.ts uncovered functions", () => {
  beforeEach(() => {
  ...
  it("calls useProfileOperations (uncovered fn L25)", () => {
    try {
      const result = (useProfileOperations as any)(
        { accountUpdate: "2024-01-01" },
        { length: 0 },
        { savedChanges: jest.fn(() => Promise.resolve({})) },
      );
