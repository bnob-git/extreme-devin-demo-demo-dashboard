...
describe("handlers body-aware tests", () => {
  ...
  it("calls createCountryChangeHandler (L5-16) with body-aware args", () => {
    try {
      const result = (createCountryChangeHandler as any)({ filter: jest.fn(() => []) }, {});
  ...
  it("calls createRestOfTheWorldChangeHandler (L25-46) with body-aware args", () => {
    try {
