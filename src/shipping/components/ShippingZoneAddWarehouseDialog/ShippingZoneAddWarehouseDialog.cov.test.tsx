...
describe("ShippingZoneAddWarehouseDialog.tsx coverage", () => {
  it("should render ShippingZoneAddWarehouseDialog", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render ShippingZoneAddWarehouseDialog with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <ShippingZoneAddWarehouseDialog
