...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls shippingZonesListStaticColumnsAdapter with mocked args", () => {
    try {
  ...
  it("calls shippingZonesListStaticColumnsAdapter with null args", () => {
    try {
      const result = (shippingZonesListStaticColumnsAdapter as any)(null as any);
