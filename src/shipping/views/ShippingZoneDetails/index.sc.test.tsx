...
test("ShippingZoneDetails can be imported", () => {
  expect(ShippingZoneDetails).toBeDefined();
});

test("ShippingZoneDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(ShippingZoneDetails, props));
  } catch (_e) {
...
test("ShippingZoneDetails renders with null values", () => {
  try {
    render(React.createElement(ShippingZoneDetails, {} as any));
  } catch (_e) {
    // Expected
  }
