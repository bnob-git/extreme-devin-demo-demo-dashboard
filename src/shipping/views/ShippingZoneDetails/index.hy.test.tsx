...
describe("index hybrid render tests", () => {
  ...
  it("renders ShippingZoneDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ShippingZoneDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ShippingZoneDetails with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ShippingZoneDetails {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
