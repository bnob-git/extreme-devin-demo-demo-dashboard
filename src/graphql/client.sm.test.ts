...
test("apolloClient executes with smart args", () => {
  try {
...
test("apolloClient with alternate values", () => {
  try {
...
test("saleorClient executes with smart args", () => {
  try {
...
test("saleorClient with alternate values", () => {
  try {
