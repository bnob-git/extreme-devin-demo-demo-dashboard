// Auto-generated coverage test for client.ts
...
jest.mock("./fragmentTypes.generated", () => {
  const proxy: any = new Proxy(function () {}, {
    get: (_: any, p: string) => {
      if (p === "__esModule") return true;
...
jest.mock("./fragmentTypesStaging.generated", () => {
  const proxy: any = new Proxy(function () {}, {
    get: (_: any, p: string) => {
      if (p === "__esModule") return true;
...
jest.mock("./typePolicies.generated", () => {
  const proxy: any = new Proxy(function () {}, {
    get: (_: any, p: string) => {
      if (p === "__esModule") return true;
...
describe("client", () => {
  ...
  it("handles apolloClient with no args", () => {
    expect(typeof apolloClient).toBe("function");
  });

  it("exports saleorClient", () => {
