...
describe("CategoryDetails deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders CategoryDetails with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <CategoryDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CategoryDetails with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <CategoryDetails {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
