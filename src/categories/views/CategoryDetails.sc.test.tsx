...
test("CategoryDetails can be imported", () => {
  expect(CategoryDetails).toBeDefined();
});

test("CategoryDetails renders without crashing", () => {
  try {
    const props = {
      params: [],
      id: "test-id",
    ...
    render(React.createElement(CategoryDetails, props));
  } catch (_e) {
...
test("CategoryDetails renders with null values", () => {
  try {
    render(React.createElement(CategoryDetails, {} as any));
  } catch (_e) {
    // Expected
  }
