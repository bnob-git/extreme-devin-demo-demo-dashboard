...
describe("CategoryList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders CategoryList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <CategoryList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CategoryList with override props", () => {
