...
test("CategoryDetails ((anonymous_14) L188) executes", () => {
  try {
    const result = (CategoryDetails as any)({} as any);
...
test("CategoryDetails ((anonymous_16) L210) executes", () => {
  try {
    const result = (CategoryDetails as any)({} as any);
...
test("CategoryDetails ((anonymous_8) L106) executes", () => {
  try {
    const result = (CategoryDetails as any)({} as any);
...
test("CategoryDetails ((anonymous_11) L146) executes", () => {
  try {
    const result = (CategoryDetails as any)({} as any);
