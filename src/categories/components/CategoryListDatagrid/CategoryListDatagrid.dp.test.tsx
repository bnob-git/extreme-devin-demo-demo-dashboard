...
jest.mock("@dashboard/categories/urls", () => ({
  ...
  categoryUrl: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("CategoryListDatagrid deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders CategoryListDatagrid with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <CategoryListDatagrid {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CategoryListDatagrid with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <CategoryListDatagrid {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
