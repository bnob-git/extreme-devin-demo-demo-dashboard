...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls categoryListStaticColumnsAdapter with mocked args", () => {
    try {
  ...
  it("calls categoryListStaticColumnsAdapter with null args", () => {
    try {
      const result = (categoryListStaticColumnsAdapter as any)(null as any, null as any);
