...
describe("AttributeListDatagrid.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders AttributeListDatagrid with deep props", () => {
    try {
      render(
        <MemoryRouter>
