...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls attributesListStaticColumnsAdapter with mocked args", () => {
    try {
  ...
  it("calls attributesListStaticColumnsAdapter with null args", () => {
    try {
      const result = (attributesListStaticColumnsAdapter as any)(null as any, null as any);
