...
describe("NumericUnits hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders NumericUnits with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <NumericUnits {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders NumericUnits with override props", () => {
