...
test("NumericUnits can be imported", () => {
  expect(NumericUnits).toBeDefined();
});

test("NumericUnits renders without crashing", () => {
  try {
    const props = {} as any;

    render(React.createElement(NumericUnits, props));
  } catch (_e) {
...
test("NumericUnits renders with null values", () => {
  try {
    render(React.createElement(NumericUnits, {} as any));
  } catch (_e) {
    // Expected
  }
