...
jest.mock("@dashboard/hooks/makeTopLevelSearch/types", () => ({
  __esModule: true,
  default: (..._a: any[]) => createDeepMock(),
  types: (..._a: any[]) => createDeepMock(),
}));
...
describe("AttributePage hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders AttributePage with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
