...
describe("handlers.ts uncovered functions", () => {
  ...
  it("calls createFetchReferencesHandler (uncovered fn L133)", () => {
    try {
  ...
  it("calls createAttributeFileChangeHandler (uncovered fn L201)", () => {
    try {
  ...
  it("calls createAttributeValueReorderHandler (uncovered fn L228)", () => {
    try {
