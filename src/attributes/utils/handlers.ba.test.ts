...
describe("handlers body-aware tests", () => {
  ...
  it("calls createFetchReferencesHandler (L133-161) with body-aware args", () => {
    try {
  ...
  it("calls createAttributeFileChangeHandler (L201-220) with body-aware args", () => {
    try {
  ...
  it("calls createAttributeValueReorderHandler (L228-240) with body-aware args", () => {
    try {
