...
describe("AttributeList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders AttributeList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <AttributeList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders AttributeList with override props", () => {
