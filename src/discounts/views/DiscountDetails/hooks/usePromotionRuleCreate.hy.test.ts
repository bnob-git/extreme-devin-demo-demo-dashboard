...
describe("usePromotionRuleCreate hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls usePromotionRuleCreate with createDeepMock args", () => {
    try {
  ...
  it("calls usePromotionRuleCreate with rich data args", () => {
    try {
  ...
  it("calls usePromotionRuleCreate with empty array", () => {
    try {
      const result = (usePromotionRuleCreate as any)([]);
