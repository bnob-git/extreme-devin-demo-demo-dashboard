...
describe("usePromotionRuleUpdate hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls usePromotionRuleUpdate with createDeepMock args", () => {
    try {
  ...
  it("calls usePromotionRuleUpdate with rich data args", () => {
    try {
  ...
  it("calls usePromotionRuleUpdate with empty array", () => {
    try {
      const result = (usePromotionRuleUpdate as any)([]);
