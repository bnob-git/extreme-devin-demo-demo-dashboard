...
test("VoucherDetails can be imported", () => {
  expect(VoucherDetails).toBeDefined();
});

test("VoucherDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(VoucherDetails, props));
  } catch (_e) {
...
test("VoucherDetails renders with null values", () => {
  try {
    render(React.createElement(VoucherDetails, {} as any));
  } catch (_e) {
    // Expected
  }
