...
test("VoucherDetails ((anonymous_11) L202) executes", () => {
  try {
    const result = (VoucherDetails as any)({} as any);
...
test("VoucherDetails ((anonymous_53) L529) executes", () => {
  try {
    const result = (VoucherDetails as any)({} as any);
...
test("VoucherDetails ((anonymous_14) L228) executes", () => {
  try {
    const result = (VoucherDetails as any)({} as any);
...
test("VoucherDetails ((anonymous_15) L239) executes", () => {
  try {
    const result = (VoucherDetails as any)({} as any);
