...
describe("VoucherList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders VoucherList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <VoucherList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders VoucherList with override props", () => {
