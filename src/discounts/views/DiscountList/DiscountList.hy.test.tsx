...
describe("DiscountList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders DiscountList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <DiscountList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders DiscountList with override props", () => {
