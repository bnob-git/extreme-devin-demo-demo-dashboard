...
describe("VoucherCreate hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders VoucherCreateView with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <VoucherCreateView {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders VoucherCreateView with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <VoucherCreateView {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
