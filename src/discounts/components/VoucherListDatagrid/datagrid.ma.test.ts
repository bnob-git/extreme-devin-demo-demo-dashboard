...
describe("datagrid multi-arg tests", () => {
  ...
  it("calls vouchersListStaticColumnsAdapter with empty_obj (variant 0)", () => {
    try {
  ...
  it("calls vouchersListStaticColumnsAdapter with intl (variant 1)", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)();
  ...
  it("calls vouchersListStaticColumnsAdapter with form_data (variant 2)", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)();
  ...
  it("calls vouchersListStaticColumnsAdapter with null_val (variant 3)", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)();
  ...
  it("calls vouchersListStaticColumnsAdapter with string_val (variant 4)", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)();
  ...
  it("calls vouchersListStaticColumnsAdapter with number_val (variant 5)", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)();
