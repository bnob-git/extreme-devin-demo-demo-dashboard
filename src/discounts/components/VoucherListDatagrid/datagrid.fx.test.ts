...
describe("datagrid fixture tests", () => {
  ...
  it("calls vouchersListStaticColumnsAdapter with saleList fixture", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)(saleList as any);
  ...
  it("calls vouchersListStaticColumnsAdapter with voucherList fixture", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)(voucherList as any);
  ...
  it("calls vouchersListStaticColumnsAdapter with sale fixture", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)(sale as any);
  ...
  it("calls vouchersListStaticColumnsAdapter with voucherDetails fixture", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)(voucherDetails as any);
  ...
  it("calls vouchersListStaticColumnsAdapter with discount fixture", () => {
    try {
      const result = (vouchersListStaticColumnsAdapter as any)(discount as any);
  ...
  it("calls vouchersListStaticColumnsAdapter with multiple fixture args", () => {
    try {
