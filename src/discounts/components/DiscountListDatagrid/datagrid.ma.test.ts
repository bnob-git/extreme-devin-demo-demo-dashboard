...
describe("datagrid multi-arg tests", () => {
  ...
  it("calls dicountListStaticColumnsAdapter with empty_obj (variant 0)", () => {
    try {
  ...
  it("calls dicountListStaticColumnsAdapter with intl (variant 1)", () => {
    try {
      const result = (dicountListStaticColumnsAdapter as any)();
  ...
  it("calls dicountListStaticColumnsAdapter with form_data (variant 2)", () => {
    try {
      const result = (dicountListStaticColumnsAdapter as any)();
  ...
  it("calls dicountListStaticColumnsAdapter with null_val (variant 3)", () => {
    try {
      const result = (dicountListStaticColumnsAdapter as any)();
  ...
  it("calls dicountListStaticColumnsAdapter with string_val (variant 4)", () => {
    try {
      const result = (dicountListStaticColumnsAdapter as any)();
  ...
  it("calls dicountListStaticColumnsAdapter with number_val (variant 5)", () => {
    try {
      const result = (dicountListStaticColumnsAdapter as any)();
