...
describe("datagrid", () => {
  test("dicountListStaticColumnsAdapter is exported", () => {
    expect(dicountListStaticColumnsAdapter).toBeDefined();
  });
  ...
  test("dicountListStaticColumnsAdapter can be called", () => {
    if (typeof dicountListStaticColumnsAdapter === "function") {
      try {
