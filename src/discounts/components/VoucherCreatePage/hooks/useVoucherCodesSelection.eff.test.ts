// Auto-generated coverage test for useVoucherCodesSelection.ts
...
jest.mock("../../VoucherCodesDatagrid/types", () => {
  const proxy: any = new Proxy(function () {}, {
    get: (_: any, p: string) => {
      if (p === "__esModule") return true;
...
describe("useVoucherCodesSelection", () => {
  it("exports useVoucherCodesSelection", () => {
    expect(typeof useVoucherCodesSelection).toBe("function");
  });
});
