...
describe("handlers body-aware tests", () => {
  ...
  it("calls createDiscountTypeChangeHandler (L20-40) with body-aware args", () => {
    try {
  ...
  it("calls createChannelsChangeHandler (L48-67) with body-aware args", () => {
    try {
  ...
  it("calls createVoucherUpdateHandler (L92-119) with body-aware args", () => {
    try {
