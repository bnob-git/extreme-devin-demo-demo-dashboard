...
describe("handlers hybrid tests", () => {
  ...
  it("calls createDiscountTypeChangeHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createDiscountTypeChangeHandler with rich data args", () => {
    try {
  ...
  it("calls createDiscountTypeChangeHandler with empty array", () => {
    try {
      const result = (createDiscountTypeChangeHandler as any)([]);
  ...
  it("calls getChannelsVariables with createDeepMock args", () => {
    try {
  ...
  it("calls createVoucherUpdateHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createVoucherUpdateHandler with rich data args", () => {
    try {
  ...
  it("calls createVoucherUpdateHandler with empty array", () => {
    try {
      const result = (createVoucherUpdateHandler as any)([]);
