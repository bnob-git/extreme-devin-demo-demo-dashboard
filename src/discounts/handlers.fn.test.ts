...
describe("handlers.ts uncovered functions", () => {
  ...
  it("calls createChannelsChangeHandler (uncovered fn L48)", () => {
    try {
  ...
  it("calls createVoucherUpdateHandler (uncovered fn L92)", () => {
    try {
  ...
  it("calls createDiscountTypeChangeHandler (uncovered fn L20)", () => {
    try {
