...
test("ChannelDetails ((anonymous_11) L140) executes", () => {
  try {
    const result = (ChannelDetails as any)({} as any);
...
test("ChannelDetails ((anonymous_13) L246) executes", () => {
  try {
    const result = (ChannelDetails as any)({} as any);
...
test("ChannelDetails ((anonymous_12) L141) executes", () => {
  try {
    const result = (ChannelDetails as any)({} as any);
