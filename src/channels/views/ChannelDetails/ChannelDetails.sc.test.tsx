...
test("ChannelDetails can be imported", () => {
  expect(ChannelDetails).toBeDefined();
});

test("ChannelDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(ChannelDetails, props));
  } catch (_e) {
...
test("ChannelDetails renders with null values", () => {
  try {
    render(React.createElement(ChannelDetails, {} as any));
  } catch (_e) {
    // Expected
  }
