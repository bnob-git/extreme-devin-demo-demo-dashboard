...
describe("ChannelDetails hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ChannelDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ChannelDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ChannelDetails with override props", () => {
