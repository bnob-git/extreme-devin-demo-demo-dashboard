...
describe("handlers hybrid tests", () => {
  ...
  it("calls createShippingZoneAddHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createShippingZoneAddHandler with rich data args", () => {
    try {
  ...
  it("calls createShippingZoneAddHandler with empty array", () => {
    try {
      const result = (createShippingZoneAddHandler as any)([]);
  ...
  it("calls createShippingZoneRemoveHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createShippingZoneRemoveHandler with rich data args", () => {
    try {
  ...
  it("calls createShippingZoneRemoveHandler with empty array", () => {
    try {
      const result = (createShippingZoneRemoveHandler as any)([]);
  ...
  it("calls createWarehouseAddHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createWarehouseAddHandler with rich data args", () => {
    try {
  ...
  it("calls createWarehouseAddHandler with empty array", () => {
    try {
      const result = (createWarehouseAddHandler as any)([]);
  ...
  it("calls createWarehouseRemoveHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createWarehouseRemoveHandler with rich data args", () => {
    try {
  ...
  it("calls createWarehouseRemoveHandler with empty array", () => {
    try {
      const result = (createWarehouseRemoveHandler as any)([]);
  ...
  it("calls createWarehouseReorderHandler with createDeepMock args", () => {
    try {
  ...
  it("calls createWarehouseReorderHandler with rich data args", () => {
    try {
  ...
  it("calls createWarehouseReorderHandler with empty array", () => {
    try {
      const result = (createWarehouseReorderHandler as any)([], createDeepMock());
