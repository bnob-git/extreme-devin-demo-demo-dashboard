...
describe("utils body-aware tests", () => {
  ...
  it("calls findMethodName (L34-80) with body-aware args", () => {
    try {
  ...
  it("calls mapOrderActionsToTransactionActions (L131-142) with body-aware args", () => {
    try {
      const result = (mapOrderActionsToTransactionActions as any)(jest.fn());
