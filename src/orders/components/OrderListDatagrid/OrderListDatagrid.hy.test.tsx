...
describe("OrderListDatagrid hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderListDatagrid with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderListDatagrid {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderListDatagrid with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderListDatagrid {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
