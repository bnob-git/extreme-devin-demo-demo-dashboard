...
describe("datagrid hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useGetCellContent with createDeepMock args", () => {
    try {
  ...
  it("calls useGetCellContent with rich data args", () => {
    try {
  ...
  it("calls useGetCellContent with empty array", () => {
    try {
      const result = (useGetCellContent as any)([], createDeepMock());
