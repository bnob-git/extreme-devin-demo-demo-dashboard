...
describe("OrderFulfillmentCancelDialog.tsx coverage", () => {
  it("should render OrderFulfillmentCancelDialog", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render OrderFulfillmentCancelDialog with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <OrderFulfillmentCancelDialog
