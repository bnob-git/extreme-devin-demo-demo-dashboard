...
describe("useHandleSubmit hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useHandleOrderLineMetadataSubmit with createDeepMock args", () => {
    try {
      const result = (useHandleOrderLineMetadataSubmit as any)(createDeepMock());
