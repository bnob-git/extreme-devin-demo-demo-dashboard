...
jest.mock("@dashboard/hooks/useAddressValidation", () => ({
  ...
  useAddressValidation: (..._a: any[]) => createDeepMock(),
}));
...
describe("OrderCustomerAddressesEditDialog hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderCustomerAddressesEditDialog with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderCustomerAddressesEditDialog {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderCustomerAddressesEditDialog with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderCustomerAddressesEditDialog {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
