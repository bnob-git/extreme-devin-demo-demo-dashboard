...
describe("OrderCustomerAddressesSearch.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders OrderCustomerAddressesSearch with deep props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderCustomerAddressesSearch
            {...({
              ...
              formChange: {},
              transitionState: {},
              openFromCustomerChange: false,
              selectedCustomerAddressId: false,
              customerAddresses: [],
