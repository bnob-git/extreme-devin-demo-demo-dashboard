...
describe("OrderCustomerAddressesEditDialog.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders OrderCustomerAddressesEditDialog with deep props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderCustomerAddressesEditDialog
            {...({
              ...
              countries: [],
              customerAddresses: [],
              defaultShippingAddress: "test",
              defaultBillingAddress: "test",
              onClose: jest.fn(),
              onConfirm: jest.fn(),
              orderShippingAddress: "test",
              orderBillingAddress: "test",
              id: "test-id",
              disabled: false,
              onSubmit: jest.fn(),
              onChange: jest.fn(),
