...
describe("OrderDetailsPage hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderDetailsPage with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderDetailsPage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderDetailsPage with override props", () => {
