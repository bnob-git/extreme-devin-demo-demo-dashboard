...
test("OrderRefundForm can be imported", () => {
  expect(OrderRefundForm).toBeDefined();
});

test("OrderRefundForm renders without crashing", () => {
  try {
    const props = {
    ...
    render(React.createElement(OrderRefundForm, props));
  } catch (_e) {
...
test("OrderRefundForm renders with null values", () => {
  try {
    render(React.createElement(OrderRefundForm, {} as any));
  } catch (_e) {
    // Expected
  }
...
test("OrderRefundForm renders with toggled boolean props", () => {
  try {
    const props = {
      children: undefined as any,
      props: [],
    ...
    render(React.createElement(OrderRefundForm, props as any));
  } catch (_e) {
    // Expected
  }
