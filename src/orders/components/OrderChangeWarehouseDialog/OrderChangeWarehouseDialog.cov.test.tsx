...
describe("OrderChangeWarehouseDialog.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders OrderChangeWarehouseDialog with deep props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders with realistic props", () => {
    const props = {
      currentWarehouseId: "test-id",
      onClose: jest.fn(),
      onConfirm: jest.fn(),
      open: false,
      warehouse: { id: "test-id", name: "Test", __typename: "Warehouse" } as any,
    };
