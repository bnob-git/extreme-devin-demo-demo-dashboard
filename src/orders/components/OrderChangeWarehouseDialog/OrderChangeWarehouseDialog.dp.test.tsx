...
jest.mock("@dashboard/orders/utils/data", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getLineAvailableQuantityInWarehouse: jest.fn((..._a: any[]) => createDeepMock()),
}));
jest.mock("@dashboard/searches/useWarehouseSearch", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  useWarehouseSearch: (..._a: any[]) => createDeepMock(),
}));
...
describe("OrderChangeWarehouseDialog deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderChangeWarehouseDialog with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderChangeWarehouseDialog {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderChangeWarehouseDialog with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <OrderChangeWarehouseDialog {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
