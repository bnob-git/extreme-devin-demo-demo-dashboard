...
describe("utils coverage", () => {
  it("calls mapActionToMessage", () => {
    try {
      const result = (mapActionToMessage as any)();
  ...
  it("calls mapTransactionEvent", () => {
    try {
      const result = (mapTransactionEvent as any)();
  ...
  it("calls getTransactionEvents", () => {
    try {
      const result = (getTransactionEvents as any)();
