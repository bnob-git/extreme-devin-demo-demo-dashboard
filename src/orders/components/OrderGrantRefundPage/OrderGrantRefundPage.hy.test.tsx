...
describe("OrderGrantRefundPage hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderGrantRefundPage with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderGrantRefundPage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderGrantRefundPage with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderGrantRefundPage {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
