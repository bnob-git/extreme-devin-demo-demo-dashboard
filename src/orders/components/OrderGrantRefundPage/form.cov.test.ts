...
describe("form deep coverage", () => {
  it("calls useGrantRefundForm with analyzed args", () => {
    try {
  ...
  it("calls useGrantRefundForm with alt args", () => {
    try {
      const result = (useGrantRefundForm as any)({
        onSubmit: undefined as any,
        grantedRefund: undefined as any,
        lines: undefined as any,
        grantRefundForShipping: undefined as any,
      });
