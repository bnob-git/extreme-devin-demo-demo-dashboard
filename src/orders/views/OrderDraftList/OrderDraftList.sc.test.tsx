...
test("OrderDraftList can be imported", () => {
  expect(OrderDraftList).toBeDefined();
});

test("OrderDraftList renders without crashing", () => {
  try {
    const props = {
      params: [],
    };

    render(React.createElement(OrderDraftList, props));
  } catch (_e) {
...
test("OrderDraftList renders with null values", () => {
  try {
    render(React.createElement(OrderDraftList, {} as any));
  } catch (_e) {
    // Expected
  }
