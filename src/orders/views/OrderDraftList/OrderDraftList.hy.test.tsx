...
describe("OrderDraftList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders OrderDraftList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderDraftList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderDraftList with override props", () => {
