...
test("OrderDetails can be imported", () => {
  expect(OrderDetails).toBeDefined();
});

test("OrderDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(OrderDetails, props));
  } catch (_e) {
...
test("OrderDetails renders with null values", () => {
  try {
    render(React.createElement(OrderDetails, {} as any));
  } catch (_e) {
    // Expected
  }
