...
describe("index hybrid render tests", () => {
  ...
  it("renders OrderDraftDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderDraftDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderDraftDetails with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderDraftDetails {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
