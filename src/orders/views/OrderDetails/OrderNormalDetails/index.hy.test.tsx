...
describe("index hybrid render tests", () => {
  ...
  it("renders OrderNormalDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderNormalDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderNormalDetails with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderNormalDetails {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
