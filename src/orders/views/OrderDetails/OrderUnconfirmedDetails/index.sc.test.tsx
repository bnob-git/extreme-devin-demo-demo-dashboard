...
test("OrderUnconfirmedDetails can be imported", () => {
  expect(OrderUnconfirmedDetails).toBeDefined();
});

test("OrderUnconfirmedDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(OrderUnconfirmedDetails, props));
  } catch (_e) {
...
test("OrderUnconfirmedDetails renders with null values", () => {
  try {
    render(React.createElement(OrderUnconfirmedDetails, {} as any));
  } catch (_e) {
    // Expected
  }
