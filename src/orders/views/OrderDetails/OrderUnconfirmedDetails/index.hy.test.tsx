...
describe("index hybrid render tests", () => {
  ...
  it("renders OrderUnconfirmedDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <OrderUnconfirmedDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders OrderUnconfirmedDetails with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <OrderUnconfirmedDetails {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
