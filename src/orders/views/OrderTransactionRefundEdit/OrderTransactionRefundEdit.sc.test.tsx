...
test("OrderTransactionRefund can be imported", () => {
  expect(OrderTransactionRefund).toBeDefined();
});

test("OrderTransactionRefund renders without crashing", () => {
  try {
    const props = {
      orderId: "test-id",
      refundId: "test-id",
    ...
    render(React.createElement(OrderTransactionRefund, props));
  } catch (_e) {
...
test("OrderTransactionRefund renders with null values", () => {
  try {
    render(React.createElement(OrderTransactionRefund, {} as any));
  } catch (_e) {
    // Expected
  }
