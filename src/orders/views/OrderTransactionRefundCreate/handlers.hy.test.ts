...
import { checkAmountExceedsChargedAmount } from "./handlers";
...
describe("handlers hybrid tests", () => {
  ...
  it("calls checkAmountExceedsChargedAmount with createDeepMock args", () => {
    try {
  ...
  it("calls checkAmountExceedsChargedAmount with rich data args", () => {
    try {
  ...
  it("calls checkAmountExceedsChargedAmount with empty array", () => {
    try {
      const result = (checkAmountExceedsChargedAmount as any)([]);
