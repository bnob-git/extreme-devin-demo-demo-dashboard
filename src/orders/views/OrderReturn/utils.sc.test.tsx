...
test("ReturnFormDataParser can be imported", () => {
  expect(ReturnFormDataParser).toBeDefined();
});

test("ReturnFormDataParser renders without crashing", () => {
  try {
    const props = {} as any;

    render(React.createElement(ReturnFormDataParser, props));
  } catch (_e) {
...
test("ReturnFormDataParser renders with null values", () => {
  try {
    render(React.createElement(ReturnFormDataParser, {} as any));
  } catch (_e) {
    // Expected
  }
