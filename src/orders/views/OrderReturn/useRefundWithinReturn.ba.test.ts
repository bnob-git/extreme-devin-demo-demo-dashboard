...
describe("useRefundWithinReturn body-aware tests", () => {
  beforeEach(() => {
  ...
  it("calls useRefundWithinReturn (L34-72) with body-aware args", () => {
    try {
      const result = (useRefundWithinReturn as any)({
        amount: 1,
        autoGrantRefund: {},
        autoSendRefund: {},
        fulfilledItemsQuantities: { map: jest.fn(() => []) },
        refundShipmentCosts: [],
        transactionId: "test-id",
        unfulfilledItemsQuantities: { map: jest.fn(() => []) },
      });
