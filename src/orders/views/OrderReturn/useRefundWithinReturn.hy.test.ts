...
describe("useRefundWithinReturn hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useRefundWithinReturn with createDeepMock args", () => {
    try {
  ...
  it("calls useRefundWithinReturn with rich data args", () => {
    try {
  ...
  it("calls useRefundWithinReturn with empty array", () => {
    try {
      const result = (useRefundWithinReturn as any)([]);
