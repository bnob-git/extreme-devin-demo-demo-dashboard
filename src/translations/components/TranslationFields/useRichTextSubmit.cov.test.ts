...
describe("useRichTextSubmit coverage", () => {
  it("calls useRichTextSubmit", () => {
    try {
      const result = (useRichTextSubmit as any)({}, jest.fn());
  ...
  it("calls useRichTextSubmit with empty args", () => {
    try {
      const result = (useRichTextSubmit as any)(undefined as any, undefined as any);
