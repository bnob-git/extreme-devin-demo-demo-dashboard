...
describe("TranslationsProductVariants.tsx coverage", () => {
  it("should render TranslationsProductVariants", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render TranslationsProductVariants with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsProductVariants
