...
describe("TranslationsCollections.tsx coverage", () => {
  it("should render TranslationsCollections", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render TranslationsCollections with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsCollections
