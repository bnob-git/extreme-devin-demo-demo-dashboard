...
jest.mock("@dashboard/utils/urls", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getMultipleUrlValues: jest.fn((..._a: any[]) => createDeepMock()),
...
describe("TranslationsProducts deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders TranslationsProducts with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsProducts {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders TranslationsProducts with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <TranslationsProducts {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
