...
jest.mock("@dashboard/utils/urls", () => ({
  __esModule: true,
  default: jest.fn((...args: any[]) => args[0] ?? {}),
  getMultipleUrlValues: jest.fn((...args: any[]) => args[0] ?? {}),
  stringifyQs: jest.fn((...args: any[]) => args[0] ?? {}),
}));
...
describe("TranslationsProducts deep-mock tests", () => {
  beforeEach(() => {
  ...
  it("renders TranslationsProducts with deep-mocked deps", () => {
    try {
      render(
        <MemoryRouter>
