...
describe("TranslationsMenuItem.tsx coverage", () => {
  it("should render TranslationsMenuItem", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render TranslationsMenuItem with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsMenuItem
