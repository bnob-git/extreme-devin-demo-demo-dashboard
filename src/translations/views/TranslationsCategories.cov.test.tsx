...
describe("TranslationsCategories.tsx coverage", () => {
  it("should render TranslationsCategories", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("should render TranslationsCategories with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsCategories
