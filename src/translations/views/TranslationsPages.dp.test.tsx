...
describe("TranslationsPages deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders TranslationsPages with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsPages {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders TranslationsPages with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <TranslationsPages {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
