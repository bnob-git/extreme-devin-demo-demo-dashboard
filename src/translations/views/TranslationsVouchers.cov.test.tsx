...
describe("TranslationsVouchers.tsx coverage", () => {
  it("should render TranslationsVouchers", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsVouchers
            {...({
              id: "test-id",
              params: {},
  ...
  it("should render TranslationsVouchers with loading state", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsVouchers
