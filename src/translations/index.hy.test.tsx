...
describe("index hybrid render tests", () => {
  ...
  it("renders TranslationsRouter with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <TranslationsRouter {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders TranslationsRouter with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <TranslationsRouter {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
