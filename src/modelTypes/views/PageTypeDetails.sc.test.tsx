...
test("PageTypeDetails can be imported", () => {
  expect(PageTypeDetails).toBeDefined();
});

test("PageTypeDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(PageTypeDetails, props));
  } catch (_e) {
...
test("PageTypeDetails renders with null values", () => {
  try {
    render(React.createElement(PageTypeDetails, {} as any));
  } catch (_e) {
    // Expected
  }
