...
jest.mock("@dashboard/hooks/useListSelectedItems", () => ({
  __esModule: true,
  default: (..._a: any[]) => createDeepMock(),
  useListSelectedItems: (..._a: any[]) => createDeepMock(),
}));
...
describe("PageTypeDetails hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders PageTypeDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <PageTypeDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PageTypeDetails with override props", () => {
