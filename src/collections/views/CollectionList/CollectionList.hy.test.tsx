...
describe("CollectionList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders CollectionList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <CollectionList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CollectionList with override props", () => {
