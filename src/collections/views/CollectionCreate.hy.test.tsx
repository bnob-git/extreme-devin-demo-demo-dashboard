...
describe("CollectionCreate hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders CollectionCreate with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <CollectionCreate {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders CollectionCreate with override props", () => {
