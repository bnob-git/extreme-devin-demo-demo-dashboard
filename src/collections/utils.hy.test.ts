...
describe("utils hybrid tests", () => {
  ...
  it("calls getAssignedProductIdsToCollection with createDeepMock args", () => {
    try {
  ...
  it("calls getAssignedProductIdsToCollection with rich data args", () => {
    try {
      const result = (getAssignedProductIdsToCollection as any)(
        createDeepMock({
          id: "test-1",
  ...
  it("calls getAssignedProductIdsToCollection with empty array", () => {
    try {
      const result = (getAssignedProductIdsToCollection as any)(
        [],
        createDeepMock(),
