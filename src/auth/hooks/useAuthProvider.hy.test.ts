...
describe("useAuthProvider hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useAuthProvider with createDeepMock args", () => {
    try {
  ...
  it("calls useAuthProvider with rich data args", () => {
    try {
  ...
  it("calls useAuthProvider with empty array", () => {
    try {
      const result = (useAuthProvider as any)([]);
