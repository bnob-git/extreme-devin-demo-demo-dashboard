// Auto-generated coverage test for useAuthRedirection.ts
...
describe("useAuthRedirection", () => {
  it("exports useAuthRedirection", () => {
    expect(typeof useAuthRedirection).toBe("function");
  });
});
