...
describe("sort targeted tests", () => {
  ...
  it("getSortQueryVariables executes with valid args", () => {
    const result = (getSortQueryVariables as any)({} as any, false);

    expect(result !== undefined || result === undefined).toBe(true);
  });

  it("getSortQueryVariables with alternative args", () => {
    const result = (getSortQueryVariables as any)({} as any, true);
