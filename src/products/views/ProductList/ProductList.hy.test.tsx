...
jest.mock("@dashboard/hooks/useBackgroundTask", () => ({
  __esModule: true,
  default: (..._a: any[]) => createDeepMock(),
  useBackgroundTask: (..._a: any[]) => createDeepMock(),
}));
jest.mock("@dashboard/hooks/useFilterHandlers", () => ({
  __esModule: true,
  default: (..._a: any[]) => createDeepMock(),
  useFilterHandlers: (..._a: any[]) => createDeepMock(),
}));
...
describe("ProductList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductList with override props", () => {
