...
jest.mock("@dashboard/utils/sort", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getOrderDirection: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("sort deep-proxy tests", () => {
  ...
  it("calls getSortQueryVariables with deep proxy args", () => {
    try {
  ...
  it("calls getSortQueryVariables with override args", () => {
    try {
      const result = (getSortQueryVariables as any)(
        createDeepMock({
          id: "test-1",
  ...
  it("calls getSortQueryVariables with null args for error paths", () => {
    try {
      const result = (getSortQueryVariables as any)(null, null, null);
  ...
  it("calls getSortQueryVariables with array data", () => {
    try {
      const result = (getSortQueryVariables as any)(
