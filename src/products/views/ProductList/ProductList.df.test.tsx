...
test("ProductList ((anonymous_12) L238) executes", () => {
  try {
    const result = (ProductList as any)({} as any);
...
test("ProductList ((anonymous_8) L167) executes", () => {
  try {
    const result = (ProductList as any)({} as any);
...
test("ProductList ((anonymous_7) L144) executes", () => {
  try {
    const result = (ProductList as any)({} as any);
