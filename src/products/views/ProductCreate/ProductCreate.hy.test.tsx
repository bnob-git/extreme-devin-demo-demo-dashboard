...
describe("ProductCreate hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductCreateView with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductCreateView {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductCreateView with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ProductCreateView {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
