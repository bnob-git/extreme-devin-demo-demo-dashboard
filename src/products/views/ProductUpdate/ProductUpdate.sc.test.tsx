...
test("ProductUpdate can be imported", () => {
...
test("ProductUpdate renders without crashing", () => {
  try {
    ...
    render(React.createElement(ProductUpdate, props));
  } catch (_e) {
...
test("ProductUpdate renders with null values", () => {
  try {
    render(React.createElement(ProductUpdate, {} as any));
  } catch (_e) {
    // Expected
  }
