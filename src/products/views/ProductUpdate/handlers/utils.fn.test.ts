...
import { getProductChannelsUpdateVariables } from "./utils";
...
describe("utils.ts uncovered functions", () => {
  ...
  it("calls getProductChannelsUpdateVariables (uncovered fn L119)", () => {
    try {
      const result = (getProductChannelsUpdateVariables as any)(
        { isAvailableForPurchase: false, isPublished: false },
        { push: {} },
      );
