...
describe("attributes deep coverage", () => {
  ...
  it("calls getAttributeType with analyzed args", () => {
    try {
  ...
  it("calls getAttributeType with alt args", () => {
    try {
      const result = (getAttributeType as any)(undefined as any, undefined as any);
  ...
  it("calls getAttributeInput with analyzed args", () => {
    try {
  ...
  it("calls getAttributeInput with alt args", () => {
    try {
      const result = (getAttributeInput as any)(undefined as any, undefined as any);
