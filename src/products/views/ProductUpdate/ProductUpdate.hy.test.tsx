...
describe("ProductUpdate hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductUpdate with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductUpdate {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductUpdate with override props", () => {
