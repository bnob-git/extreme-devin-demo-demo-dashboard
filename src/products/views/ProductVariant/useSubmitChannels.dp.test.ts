...
describe("useSubmitChannels deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("calls useSubmitChannels with deep proxy args", () => {
    try {
  ...
  it("calls useSubmitChannels with override args", () => {
    try {
  ...
  it("calls useSubmitChannels with null args for error paths", () => {
    try {
      const result = (useSubmitChannels as any)(null, null);
  ...
  it("calls useSubmitChannels with array data", () => {
    try {
      const result = (useSubmitChannels as any)(
