...
jest.mock("@dashboard/hooks/useOnSetDefaultVariant", () => ({
  __esModule: true,
  default: (..._a: any[]) => createDeepMock(),
  useOnSetDefaultVariant: (..._a: any[]) => createDeepMock(),
}));
...
describe("ProductVariant hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductVariant with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductVariant {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductVariant with override props", () => {
