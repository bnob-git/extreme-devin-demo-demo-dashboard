...
describe("handlers coverage", () => {
  it("calls createChannelsPriceChangeHandler", () => {
    try {
  ...
  it("calls createChannelsPriceChangeHandler with empty args", () => {
    try {
      const result = (createChannelsPriceChangeHandler as any)(undefined as any, undefined as any);
  ...
  it("calls createChannelsChangeHandler", () => {
    try {
  ...
  it("calls createChannelsChangeHandler with empty args", () => {
    try {
  ...
  it("calls createProductTypeSelectHandler", () => {
    try {
  ...
  it("calls createProductTypeSelectHandler with empty args", () => {
    try {
      const result = (createProductTypeSelectHandler as any)(undefined as any);
  ...
  it("calls getAvailabilityVariables", () => {
    try {
  ...
  it("calls createPreorderEndDateChangeHandler", () => {
    try {
  ...
  it("calls createMediaChangeHandler", () => {
    try {
