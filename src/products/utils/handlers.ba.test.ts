...
describe("handlers body-aware tests", () => {
  ...
  it("calls createChannelsPriceChangeHandler (L25-33) with body-aware args", () => {
    try {
  ...
  it("calls createChannelsChangeHandler (L41-55) with body-aware args", () => {
    try {
  ...
  it("calls createProductTypeSelectHandler (L62-67) with body-aware args", () => {
    try {
  ...
  it("calls getChannelsInput (L71-80) with body-aware args", () => {
    try {
  ...
  it("calls getAvailabilityVariables (L85-105) with body-aware args", () => {
    try {
  ...
  it("calls createPreorderEndDateChangeHandler (L113-123) with body-aware args", () => {
    try {
  ...
  it("calls createMediaChangeHandler (L126-134) with body-aware args", () => {
    try {
      const result = (createMediaChangeHandler as any)({ change: jest.fn(() => []) }, {});
