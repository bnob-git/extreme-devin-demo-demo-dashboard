...
describe("ProductMedia.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders ProductMedia with deep props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductMedia
  ...
  it("renders with realistic props", () => {
    const props = {
      getEditHref: { current: null } as any,
      id: "test-id",
      loading: false,
      media: [] as any,
      onDelete: jest.fn(),
