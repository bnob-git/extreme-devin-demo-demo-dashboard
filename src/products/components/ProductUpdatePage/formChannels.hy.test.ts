...
describe("formChannels hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useProductChannelListingsForm with createDeepMock args", () => {
    try {
  ...
  it("calls useProductChannelListingsForm with rich data args", () => {
    try {
  ...
  it("calls useProductChannelListingsForm with empty array", () => {
    try {
      const result = (useProductChannelListingsForm as any)([], createDeepMock());
