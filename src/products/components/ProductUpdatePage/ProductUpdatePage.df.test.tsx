...
test("ProductUpdatePage ((anonymous_11) L276) executes", () => {
  try {
    const result = (ProductUpdatePage as any)([] as any, [] as any);
...
test("ProductUpdatePage ((anonymous_11) L276) with alt args", () => {
  try {
    const result = (ProductUpdatePage as any)({} as any, {} as any);
...
test("ProductUpdatePage ((anonymous_14) L388) executes", () => {
  try {
    const result = (ProductUpdatePage as any)([] as any, [] as any);
...
test("ProductUpdatePage ((anonymous_14) L388) with alt args", () => {
  try {
    const result = (ProductUpdatePage as any)({} as any, {} as any);
