...
describe("datagrid hybrid tests", () => {
  ...
  it("calls useChannelAdapter with createDeepMock args", () => {
    try {
  ...
  it("calls useChannelAvailabilityAdapter with createDeepMock args", () => {
    try {
  ...
  it("calls useAttributesAdapter with createDeepMock args", () => {
    try {
  ...
  it("calls useAttributesAdapter with rich data args", () => {
    try {
  ...
  it("calls useAttributesAdapter with empty array", () => {
    try {
      const result = (useAttributesAdapter as any)([]);
  ...
  it("calls useWarehouseAdapter with createDeepMock args", () => {
    try {
