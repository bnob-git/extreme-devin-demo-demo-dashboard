...
describe("OrderDiscountProvider.tsx deep coverage", () => {
  beforeEach(() => {
  ...
  it("renders OrderDiscountProvider with deep props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders OrderDiscountContext", () => {
    try {
      render(
        <MemoryRouter>
