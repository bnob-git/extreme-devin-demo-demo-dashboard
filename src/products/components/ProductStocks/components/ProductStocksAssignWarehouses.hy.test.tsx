...
describe("ProductStocksAssignWarehouses hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders ProductStocksAssignWarehouses with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
  ...
  it("renders ProductStocksAssignWarehouses with override props", () => {
    ...
    try {
      render(
        <MemoryRouter>
          <ProductStocksAssignWarehouses {...(props as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
