...
test("ProductVariantUpdateForm ((anonymous_15) L288) executes", () => {
  try {
    const result = (ProductVariantUpdateForm as any)({} as any);
...
test("ProductVariantUpdateForm ((anonymous_25) L354) executes", () => {
  try {
    const result = (ProductVariantUpdateForm as any)({} as any);
...
test("ProductVariantUpdateForm ((anonymous_16) L289) executes", () => {
  try {
    const result = (ProductVariantUpdateForm as any)({} as any);
