...
describe("ProductVariantPage", () => {
  test("ProductVariantPage is exported", () => {
    expect(ProductVariantPage).toBeDefined();
  });

  test("ProductVariantPage can be called", () => {
    if (typeof ProductVariantPage === "function") {
      try {
        (ProductVariantPage as any)();
      } catch (_e) {
        /* ok */
      }
    }
