...
jest.mock("@dashboard/products/utils/data", () => ({
  ...
  getAttributeInputFromVariant: jest.fn((..._a: any[]) => createDeepMock()),
  getStockInputFromVariant: jest.fn((..._a: any[]) => createDeepMock()),
}));
jest.mock("@dashboard/products/utils/handlers", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  createMediaChangeHandler: jest.fn((..._a: any[]) => createDeepMock()),
...
describe("form deep-proxy tests", () => {
  ...
  it("renders ProductVariantUpdateForm with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <ProductVariantUpdateForm {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders ProductVariantUpdateForm with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <ProductVariantUpdateForm {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
