...
jest.mock("@dashboard/hooks/makeSearch", () => ({
  ...
  makeSearch: (..._a: any[]) => createDeepMock(),
}));

import useAttributeValueSearchHandler from "./attributeValueSearchHandler";

describe("attributeValueSearchHandler hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useAttributeValueSearchHandler with createDeepMock args", () => {
    try {
  ...
  it("calls useAttributeValueSearchHandler with rich data args", () => {
    try {
  ...
  it("calls useAttributeValueSearchHandler with empty array", () => {
    try {
      const result = (useAttributeValueSearchHandler as any)([], createDeepMock());
