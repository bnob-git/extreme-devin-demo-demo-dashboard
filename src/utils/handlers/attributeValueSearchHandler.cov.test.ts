...
describe("attributeValueSearchHandler deep coverage", () => {
  it("calls useAttributeValueSearchHandler with analyzed args", () => {
    try {
  ...
  it("calls useAttributeValueSearchHandler with alt args", () => {
    try {
      const result = (useAttributeValueSearchHandler as any)(undefined as any);
