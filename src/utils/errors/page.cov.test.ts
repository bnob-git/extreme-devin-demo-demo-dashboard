...
import getPageErrorMessage from "./page";

describe("page coverage", () => {
  it("calls getPageErrorMessage", () => {
    try {
      const result = (getPageErrorMessage as any)({}, "test", {
  ...
  it("calls getPageErrorMessage with empty args", () => {
    try {
      const result = (getPageErrorMessage as any)(
        undefined as any,
        undefined as any,
        undefined as any,
      );
