...
describe("makeMutation hybrid tests", () => {
  beforeEach(() => {
  ...
  it("calls useMutation with createDeepMock args", () => {
    try {
  ...
  it("calls useMutation with rich data args", () => {
    try {
  ...
  it("calls useMutation with empty array", () => {
    try {
      const result = (useMutation as any)([], createDeepMock(), createDeepMock());
