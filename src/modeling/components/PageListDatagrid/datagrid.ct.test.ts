...
describe("datagrid comprehensive tests", () => {
  ...
  it("calls pageListStaticColumnsAdapter with mocked args", () => {
    try {
  ...
  it("calls pageListStaticColumnsAdapter with null args", () => {
    try {
      const result = (pageListStaticColumnsAdapter as any)(null as any, null as any);
