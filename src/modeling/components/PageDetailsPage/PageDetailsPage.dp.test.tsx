...
jest.mock("@dashboard/extensions/getExtensionsItems", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  getExtensionsItemForPageDetails: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
jest.mock("@dashboard/modeling/urls", () => ({
  __esModule: true,
  default: jest.fn((..._a: any[]) => createDeepMock()),
  modelingSection: jest.fn((..._a: any[]) => createDeepMock()),
}));
...
describe("PageDetailsPage deep-proxy tests", () => {
  beforeEach(() => {
  ...
  it("renders PageDetailsPage with deep proxy props", () => {
    try {
      render(
        <MemoryRouter>
          <PageDetailsPage {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PageDetailsPage with override props", () => {
    try {
      ...
      render(
        <MemoryRouter>
          <PageDetailsPage {...(mockProps as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
