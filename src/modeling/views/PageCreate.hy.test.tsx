...
describe("PageCreate hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders PageCreate with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <PageCreate {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PageCreate with override props", () => {
