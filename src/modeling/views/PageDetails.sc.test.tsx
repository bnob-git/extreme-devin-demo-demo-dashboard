...
test("PageDetails can be imported", () => {
  expect(PageDetails).toBeDefined();
});

test("PageDetails renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(PageDetails, props));
  } catch (_e) {
...
test("PageDetails renders with null values", () => {
  try {
    render(React.createElement(PageDetails, {} as any));
  } catch (_e) {
    // Expected
  }
