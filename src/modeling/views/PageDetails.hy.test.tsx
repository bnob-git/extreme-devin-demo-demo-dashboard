...
describe("PageDetails hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders PageDetails with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <PageDetails {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PageDetails with override props", () => {
