...
describe("PageList hybrid render tests", () => {
  beforeEach(() => {
  ...
  it("renders PageList with deepMock props", () => {
    try {
      render(
        <MemoryRouter>
          <PageList {...(createDeepMock() as any)} />
        </MemoryRouter>,
      );
    } catch (_e) {
      /* expected */
  ...
  it("renders PageList with override props", () => {
