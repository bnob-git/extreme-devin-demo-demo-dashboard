...
test("PageCreate can be imported", () => {
  expect(PageCreate).toBeDefined();
});

test("PageCreate renders without crashing", () => {
  try {
    const props = {
      id: "test-id",
      params: [],
    ...
    render(React.createElement(PageCreate, props));
  } catch (_e) {
...
test("PageCreate renders with null values", () => {
  try {
    render(React.createElement(PageCreate, {} as any));
  } catch (_e) {
    // Expected
  }
